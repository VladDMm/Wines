                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (!empty($rows['message'])) {
                                                                $qr_text = $rows['message'];
                                                                $qr_text_encoded = urlencode($qr_text);
                                                                $file_path = "../qr_codes/" . md5($qr_text) . ".png";

                                                                if (!file_exists($file_path)) {
                                                                    file_put_contents($file_path, file_get_contents("https://quickchart.io/qr?text={$qr_text_encoded}&size=100"));
                                                                }
                                                        ...
                                                        <!-- QR Code for video link -->
                                                        <td>
                                                            <?php
                                                            if (!empty($rows['video_link'])) {
                                                                $qr_text = $rows['video_link'];
                                                                $qr_text_encoded = urlencode($qr_text);
                                                                $file_path = "../qr_codes/" . md5($qr_text) . ".png";
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($status == "" || $status == "NULL") {
                                                                ...
                                                                echo '<button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> În curs de livrare!</button>';
                                                            } elseif ($status == "closed") {
                                                                echo '<button type="button" class="btn btn-primary"><span class="fa fa-check-circle" aria-hidden="true"></span> Livrat</button>';
                                                            } elseif ($status == "rejected") {
                                                                echo '<button type="button" class="btn btn-danger"><i class="fa fa-close"></i> Anulat</button>';
                                                            }
                                                            ?>
                                                        </td>
