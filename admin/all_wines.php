                                                ...
                                                <div class="table-responsive m-t-40">
                                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
												$sql="SELECT * FROM wines order by w_id desc";
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
                                                            while($rows = mysqli_fetch_array($query)) {
                                                                // Obținem service_id din wines
                                                                $mql = "SELECT * FROM wines WHERE w_id='" . $rows['w_id'] . "'";
                                                                ...
                                                                echo '<tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="delete_menu.php?menu_del=' . $rows['w_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                                                                                <i class="fa fa-trash-o" style="font-size:16px"></i>
                                                                            </a> 
                                                                            <a href="update_menu.php?menu_upd=' . $rows['w_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
