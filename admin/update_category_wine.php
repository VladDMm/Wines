...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $mql = "update wine_category set wcat_name ='$_POST[c_name]' where c_id='$_GET[cat_upd]'";
        mysqli_query($db, $mql);
...
<head>
    ...
    <title>Update Category Wine</title>
    ...
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Vinuri</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_category_wine.php">Adaugă Categorie Produs</a></li>
        ...
        <div class="page-wrapper">
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href=""></a>Mihai Vlad</marquee>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Actualizează Categoria Vinului</h4>
                                </div>
                                <div class="card-body">
                                    <form action='' method='post'>
                                        <div class="form-body">
                                            <?php $ssql = "select * from wine_category where wcat_id='$_GET[cat_upd]'";
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="add_category_wine.php" class="btn btn-inverse">Cancel</a>
                                            </div>
                                    </form>
                                </div>
                            </div>
