...
if(isset($_POST['submit']))          
{
		...
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['service_name']==''||$_POST['pers_count'] == '')
		{	
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Toate campurile trebuie completate!</strong>
															</div>';
									...
									if($fsize > 1024 * 1024 * 1024 * 1024)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Max Image Size is 3mb!</strong> Try different Image.
															</div>';
									...
									else
										{
												...
												$sql = "INSERT INTO tourism(service_id,title,slogan,pers_count,price,img) VALUE('".$_POST['service_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['pers_count']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																 Tur adaugat cu succes.
															</div>';
                                    ...
                                    <ul id="sidebarnav">
                                        ...
                                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Servicii</span></a>
                                            <ul aria-expanded="false" class="collapse">
                                                ...
                                                <li><a href="add_serices.php">Adaugă Serviciu</a></li>
                                        ...
                                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Vinuri</span></a>
                                            <ul aria-expanded="false" class="collapse">
                                                ...
                                                <li><a href="add_wines.php">Addaugă Vin</a></li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        <div class="card-header">
                                            <h4 class="m-b-0 text-white">Adaugă Tur</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action='' method='post' enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Preţ </label>
                                                                <input type="text" name="price" class="form-control" placeholder="MDL">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Număr Maxim Persoane </label>
                                                                <input type="text" name="pers_count" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Selectează Serviciul</label>
                                                                <select name="service_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option>--Selectează Serviciul--</option>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_wines.php" class="btn btn-inverse">Cancel</a>
                                        </div>
                                        </form>
                                    </div>
