...
-- Dumping data for table wine_db.remark: ~12 rows (approximately)
...
-- Dumping data for table wine_db.service_cat: ~4 rows (approximately)
...
INSERT INTO `users` (`u_id`, `username`, `f_name`, `l_name`, `email`, `phone`, `password`, `address`, `order_count`, `status`, `date`) VALUES
	(9, 'test', 'testt', 'testt', 'test@gmail.com', '373787878777', '8287458823facb8ff918dbfabcd22ccb', 'Cahul, Cahul', 23, 1, '2025-02-06 06:11:46');
...
-- Dumping data for table wine_db.users_orders: ~1 rows (approximately)
INSERT INTO `users_orders` (`o_id`, `u_id`, `title`, `status`, `quantity`, `price`, `message`, `video_link`, `date`) VALUES
	(13, 9, 'Merlott', 'in process', 1, 20, 'test', 'https://www.youtube.com/watch?v=KFKMEiuCY6M', '2025-02-06 06:13:07'),
	(14, 9, 'Cabernet Sauvignon', 'in process', 1, 25, '', '', '2025-02-06 06:13:40');
