...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/index.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Comandați livrare și take-out </h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Alege Produsul</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Livrare</h4>
                    </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>Vă acoperim cu meniuri de la o varietate de servicii cu livrare online.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Alege Produsul</h3>
                            <p>Vă acoperim cu o varietate de servicii cu livrare online.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Achitare la Livrare Cash sau prin Terminal POS</p>
                </div>
            </div>
        </div>
    </section>
